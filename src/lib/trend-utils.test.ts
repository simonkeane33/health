...
function makeDay(date: string, overrides: Partial<DailySummary> = {}): DailySummary {
  return {
    ...
    entry_date: date,
    total_calories: overrides.total_calories,
    protein_g: overrides.protein_g,
    carbs_g: overrides.carbs_g,
    fat_g: overrides.fat_g,
    fiber_g: overrides.fiber_g,
    sugar_g: overrides.sugar_g,
    fluids_ml: overrides.fluids_ml,
    alcohol_units: overrides.alcohol_units,
    food_entries: overrides.food_entries,
    needs_review_count: overrides.needs_review_count,
