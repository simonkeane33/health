    ...
    <div className="min-h-screen bg-background">
      <header className="border-b px-4 lg:px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-semibold leading-tight">Log Food / Drink</h1>
            <p className="text-[11px] text-muted-foreground">Enter a meal or drink and download the Markdown entry.</p>
          </div>
        </div>
